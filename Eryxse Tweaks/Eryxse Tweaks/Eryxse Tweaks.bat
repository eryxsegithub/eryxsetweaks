...
echo.
echo.
echo                                                 %lime% Developed by%u% %violet%Eryxse%u%
...
echo.
echo %u%Developed by: %red%Eryxse
echo %u%Github: %red%https://github.com/eryxsegithub/
echo.
echo.
...
echo.
echo %u%Developed by: %green%Eryxse
echo %u%Github: %green%https://github.com/eryxsegithub
echo.
echo.
...
echo.
echo                                            %c% /$$$$$$$$ /$$$$$$$  /$$     /$$ /$$   /$$  /$$$$$$  /$$$$$$$$ %u%%white%
echo                                            %c%| $$_____/| $$__  $$|  $$   /$$/| $$  / $$ /$$__  $$| $$_____/ %u%%white%
echo                                            %c%| $$      | $$  \ $$ \  $$ /$$/ |  $$/ $$/| $$  \__/| $$       %u%%white%
echo                                            %c%| $$$$$   | $$$$$$$/  \  $$$$/   \  $$$$/ |  $$$$$$ | $$$$$    %u%%white%
echo                                            %c%| $$__/   | $$__  $$   \  $$/     >$$  $$  \____  $$| $$__/    %u%%white%
echo                                            %c%| $$      | $$  \ $$    | $$     /$$/\  $$ /$$  \ $$| $$       %u%%white%
echo                                            %c%| $$$$$$$$| $$  | $$    | $$    | $$  \ $$|  $$$$$$/| $$$$$$$$ %u%%white%
echo                                            %c%|________/|__/  |__/    |__/    |__/  |__/ \______/ |________/ %u%%white%
echo.
echo.
...
echo.
echo.
echo                                %c%Eryxse%u%%white% Tweaks%u%%c% is a batch script that optimizes your system%u%
...
echo.
echo.
echo                                %c%Eryxse Tweaks is a tweaking script that optimizes your system%u% 
echo                                       %c%to provide the best gaming experience possible.%u%
echo.
echo.
echo.
...
echo.
echo.
echo      %green%▌ Creator:%u% %c%Eryxse%u%
echo      %green%▌ Purpose:%u% %c%Improve System Performance%u%
echo      %green%▌ Version:%u% %c%%version% %u%
echo.
echo.
echo      %c%Eryxse Tweaks represents months of research and collections of pc tweaks%u%
...
echo.
echo.
echo %c%Eryxse Tweaks is a professional optimization suite designed to enhance%u% 
